...
function HomeSection({
  ...
  // Social & Stats
  const instagramUrl = workspace?.instagramUrl;
  const whatsappUrl = workspace?.whatsappUrl;
  const facebookUrl = workspace?.facebookUrl;
  const hasSocial = instagramUrl || whatsappUrl || facebookUrl;
  const hasStats = workspace?.yearsInMarket || workspace?.clientsServed || workspace?.ratingScore;
    ...
    <div style={{ padding: '0 0 24px' }}>
      ...
      {hideQuickActions && (workspace?.profile?.addressLine || workspace?.ratingScore) && (
        <div style={{
          ...
          {workspace.ratingScore && (
            <span style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
              <span style={{ color: '#f59e0b', fontSize: 14 }}>★</span>
              {workspace.ratingScore}
              {workspace.totalReviews && (
                <span style={{ color: COLORS.textMuted }}> ({workspace.totalReviews} avaliações)</span>
              )}
            </span>
          )}
        </div>
        ...
        <div style={{
          ...
          {workspace.ratingScore && (
            <div style={{
              ...
              <div style={{ fontSize: 11, color: COLORS.textSecondary, fontWeight: 500 }}>
                {workspace.totalReviews ? `${workspace.totalReviews} avaliações` : 'Avaliação'}
              </div>
            </div>
          )}
          {workspace.clientsServed && (
            <div style={{
              flex: '1 0 0', minWidth: 100,
              padding: '16px 14px', background: '#fff',
              borderRadius: 16, textAlign: 'center',
              ...
              <div style={{ fontSize: 22, fontWeight: 800, color: primaryColor, marginBottom: 4 }}>
                👥 {workspace.clientsServed}
              </div>
              <div style={{ fontSize: 11, color: COLORS.textSecondary, fontWeight: 500 }}>
                Clientes atendidos
          ...
          {workspace.yearsInMarket && (
            <div style={{
              ...
              <div style={{ fontSize: 11, color: COLORS.textSecondary, fontWeight: 500 }}>
                {workspace.yearsInMarket === 1 ? 'Ano no mercado' : 'Anos no mercado'}
              </div>
            </div>
          )}
        </div>
      ...
      {(aboutText || hasSocial) && (
        <section aria-label="Sobre o estabelecimento" style={{
          ...
          {hasSocial && (
            <div style={{
              marginTop: 16, paddingTop: aboutText ? 14 : 0,
              borderTop: aboutText ? '1px solid #f3f4f6' : 'none',
              ...
              {whatsappUrl && (
                <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" style={{
                  ...
                  background: '#25D36608', border: '1px solid #25D36620',
              ...
              {instagramUrl && (
                <a href={instagramUrl} target="_blank" rel="noopener noreferrer" style={{
                  ...
                  color: '#E4405F', fontSize: 13, fontWeight: 600,
                  textDecoration: 'none', transition: 'all 0.2s',
                }}>
    ...
    <div style={{ minHeight: '100vh', background: COLORS.background }}>
      ...
      {usePremiumLayout ? (
        <HeroSection
          ...
          ctaText={booking.workspace?.ctaText}
        />
      ) : (
      ...
      <div style={{
        ...
        marginTop: usePremiumLayout ? -48 : 0,
        borderRadius: usePremiumLayout ? '28px 28px 0 0' : '0',
        maxWidth: 560,
        marginInline: 'auto',
        position: 'relative',
        zIndex: 1,
        boxShadow: usePremiumLayout ? '0 -10px 40px rgba(0,0,0,0.15)' : 'none',
      ...
      {activeTab === 'home' && (
        <footer style={{
          ...
          {(booking.workspace?.instagramUrl || booking.workspace?.whatsappUrl || booking.workspace?.facebookUrl) && (
            <div style={{ display: 'flex', justifyContent: 'center', gap: 12, marginBottom: 16 }}>
              {booking.workspace.whatsappUrl && (
                <a href={booking.workspace.whatsappUrl} target="_blank" rel="noopener noreferrer" style={{
              ...
              {booking.workspace.instagramUrl && (
                <a href={booking.workspace.instagramUrl} target="_blank" rel="noopener noreferrer" style={{
                  width: 40, height: 40, borderRadius: 12, background: '#fff',
                  border: '1px solid #e5e7eb', display: 'flex', alignItems: 'center', justifyContent: 'center',
              ...
              {booking.workspace.facebookUrl && (
                <a href={booking.workspace.facebookUrl} target="_blank" rel="noopener noreferrer" style={{
                  width: 40, height: 40, borderRadius: 12, background: '#fff',
                  border: '1px solid #e5e7eb', display: 'flex', alignItems: 'center', justifyContent: 'center',
